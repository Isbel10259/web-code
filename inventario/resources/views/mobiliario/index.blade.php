    ...
    <div class="card">
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                <div class="card">
                    <div class="card-body">
                        <form action="mobiliario" id="insertar-mobiliario">
                            @csrf
                            <div class="row" style="padding-left:140px";>
                                ...
                                <div class="col-md-6 col-lg-5">
                                    <div class="form-group form-floating-label">
                                        <input type="text" class="form-control input-solid" id="marca" name="marca">
                                    ...
                                    <br>
                                    <div class="form-group form-floating-label">
                                        <input type="text" class="form-control input-solid" id="dimension" name="dimension">
                                        <label for="inputFloatingLabel2" class="placeholder"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><i class="fas fa-ruler-combined"></i>  Dimensión</font></font></label>
                                    </div>
                                    ...
                                    <div class="form-group form-floating-label">
                                        <select class="form-control input-solid" style="visibility:hidden" id="selcategoria" name="selcategoria" required="">
                                            ...
                                            <option selected="selected" value="2">Mobiliario</option>
...
<!-- Modal -->
<div class="modal fade" id="ModalMobiliario" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <form id="editar_mobiliario">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group form-floating-label">
                                <input type="text" class="form-control input-solid" id="marca2" name="marca2">
                                <label for="inputFloatingLabel2" class="placeholder"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><i class="fas fa-tags"></i>  Marca</font></font></label>
                            </div>
                            <br>
                            <div class="form-group form-floating-label">
                                <input type="text" class="form-control input-solid" id="dimension2" name="dimension2">
                                <label for="inputFloatingLabel2" class="placeholder"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><i class="fas fa-ruler-combined"></i>  Dimensión</font></font></label>
                            </div>
...
<!-- Modal Eliminar-->
<div class="modal fade" id="eliminarMobiliario" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
<script>
    ...
    $('#insertar-mobiliario').submit(function(e){
        e.preventDefault();
        ...
        $.ajax({
            url: "{{ route('mobiliario.registrar') }}",
            type: "POST",
            data:{
                pat_codigo: codigo,
                pat_descripcion: descripcion,
                pat_marca: marca,
                pat_dimension: dimension,
                pat_color: color,
                pat_estado: estado,
...
<script>
    ...
    $(document).on('click','.delete',function(){
        ...
        $('#eliminarMobiliario').modal('show');

    });
    $('#btneliminar').click(function(){
        $.ajax({
            url : "mobiliario/eliminar/"+patid,
            beforeSend:function(){
                $('#btneliminar').text('Eliminando...');
            },
            success:function(data){
                setTimeout(function(){
                    $('#eliminarMobiliario').modal('hide');
...
<script>
    //EDITAR PATRIMONIO
    function editarMobiliario(pat_id){
        $.get('mobiliario/editar/'+pat_id, function(patrimonio){
            ...
            $('#dimension2').val(patrimonio[0].pat_dimension);
...
<script>
    //ACTUALIZAR EQUIPO
    $('#editar_mobiliario').submit(function(e){
        e.preventDefault();
        var id2=$('#id2').val();
        ...
        $.ajax({
            url: "{{ route('mobiliario.actualizar') }}",
            type: "POST",
            data:{
                pat_id:id2,
                pat_codigo: codigo2,
