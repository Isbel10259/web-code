<x-guest-layout>
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('login') }}">
			...
			<div class="flex items-center mt-4" style="justify-content: right; margin-right: 15px;">
				<a class="underline text-sm text-blue-700 hover:text-gray-900" href="{{ route('register') }}">
					{{ __('Registrarse') }}
				</a>
			</div>
        </form>
