    ...
    <div class="card">
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                <div class="card">
                    <div class="card-body">
                        <form action="equipo" id="insertar-equipo">
                            @csrf
                            <div class="row" style="padding-left:140px";>
                                ...
                                <div class="col-md-6 col-lg-5">
                                    <div class="form-group form-floating-label">
                                        <input type="text" class="form-control input-solid" id="modelo" name="modelo" required>
                                    ...
                                    <br>
                                    <div class="form-group form-floating-label">
                                        <input type="text" class="form-control input-solid" id="serie" name="serie" required>
                                        <label for="inputFloatingLabel2" class="placeholder"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><i class="fab fa-expeditedssl"></i>  Serie</font></font></label>
                                    </div>
                                    <br>
                                    ...
                                    <div class="form-group form-floating-label">
                                        <select class="form-control input-solid" style="visibility:hidden" id="selcategoria" name="selcategoria" required="">
                                            <option value="">&nbsp;</option>
                                            <option selected="selected" value="1">Equipo</option>
            ...
            <form id="editar_equipo">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="form-group form-floating-label">
                                <input type="text" class="form-control input-solid" id="modelo2" name="modelo2" required>
                                <label for="inputFloatingLabel2" class="placeholder"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><i class="fas fa-cubes"></i>  Modelo</font></font></label>
                            </div>
                            <br>
                            <div class="form-group form-floating-label">
                                <input type="text" class="form-control input-solid" id="serie2" name="serie2" required>
                                <label for="inputFloatingLabel2" class="placeholder"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><i class="fab fa-expeditedssl"></i>  Serie</font></font></label>
                            </div>
                            <br>
                            <div class="form-check">
...
<!-- Modal Eliminar-->
<div class="modal fade" id="eliminarPatrimonio" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
<script>
    ...
    $('#insertar-equipo').submit(function(e){
        e.preventDefault();
...
<script>
    ...
    $(document).on('click','.delete',function(){
        ...
        $('#eliminarPatrimonio').modal('show');

    });
    $('#btneliminar').click(function(){
        $.ajax({
            url : "equipo/eliminar/"+patid,
            beforeSend:function(){
                $('#btneliminar').text('Eliminando...');
            },
            success:function(data){
                setTimeout(function(){
                    $('#eliminarPatrimonio').modal('hide');
...
<script>
    //EDITAR PATRIMONIO
    function editarEquipo(pat_id){
        $.get('equipo/editar/'+pat_id, function(patrimonio){
            ...
            $('#serie2').val(patrimonio[0].pat_serie);
...
<script>
    //ACTUALIZAR EQUIPO
    $('#editar_equipo').submit(function(e){
        e.preventDefault();
        var id2=$('#id2').val();
