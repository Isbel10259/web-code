    ...
    <div class="card">
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                <div class="card">
                    <div class="card-body">
                        <form action="vehiculo" id="insertar-vehiculo">
                            @csrf
                                ...
                                <div class="col-md-6 col-lg-5">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-6">
                                            <div class="form-group form-floating-label">
                                                <input type="text" class="form-control input-solid" id="placa" name="placa" required>
                                                <label for="inputFloatingLabel2" class="placeholder"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><i class="fas fa-money-check"></i>  PLaca</font></font></label>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-6">
                                            <div class="form-group form-floating-label">
                                                <input type="text" class="form-control input-solid" id="anio" name="anio" required pattern="[0-9]{4}">
                                                <label for="inputFloatingLabel2" class="placeholder"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><i class="far fa-calendar-alt"></i>  Año</font></font></label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group form-floating-label">
                                        <select class="form-control input-solid" style="visibility:hidden" id="selcategoria" name="selcategoria" required="">
                                            ...
                                            <option selected="selected" value="3">Vehículo</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group form-floating-label">
                                        <input type="text" class="form-control input-solid" id="placa2" name="placa2" required>
                                        <label for="inputFloatingLabel2" class="placeholder"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><i class="fas fa-money-check"></i>  PLaca</font></font></label>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group form-floating-label">
                                        <input type="text" class="form-control input-solid" id="anio2" name="anio2" required pattern="[0-9]{4}">
                                        <label for="inputFloatingLabel2" class="placeholder"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><i class="far fa-calendar-alt"></i>  Año</font></font></label>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    $('#insertar-vehiculo').submit(function(e){
        e.preventDefault();
...
<script>
    ...
    $(document).on('click','.delete',function(){
        ...
        $('#eliminarVehiculo').modal('show');

    });
    $('#btneliminar').click(function(){
        $.ajax({
            url : "vehiculo/eliminar/"+patid,
            beforeSend:function(){
...
<script>
    //EDITAR PATRIMONIO
    function editarVehiculo(pat_id){
        $.get('vehiculo/editar/'+pat_id, function(patrimonio){
            ...
            $('#placa2').val(patrimonio[0].pat_placa);
            $('#anio2').val(patrimonio[0].pat_anio);
